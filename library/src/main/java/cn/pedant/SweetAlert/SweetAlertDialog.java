...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private boolean mTouchOutsideClose = false;
    ...
    public SweetAlertDialog(Context context, int alertType) {
        ...
        setCancelable(true);
        setCanceledOnTouchOutside(mTouchOutsideClose);
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case SUCCESS_TYPE:
                    ...
                    break;
                case WARNING_TYPE:
                    mConfirmButton.setBackgroundResource(R.drawable.alert_dialog_button_shaper);
    ...
    public SweetAlertDialog setTouchOutsideClose(boolean shouldClose) {
        mTouchOutsideClose = shouldClose;
        return this;
    }
