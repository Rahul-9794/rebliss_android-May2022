...
public class ReadMoreTextView extends AppCompatTextView {
    ...
    private ExpandCollapseListener collapseListener;
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        ...
        this.colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_colorClickableText, ContextCompat.getColor(context, R.color.material_deep_teal_50));
        this.showTrimExpandedText =
                typedArray.getBoolean(R.styleable.ReadMoreTextView_showTrimExpandedText,
    ...
    public void addClickListener(ExpandCollapseListener listener) {
        this.collapseListener = listener;
    }

    public void setReadMoreState(boolean state) {
        this.readMore = state;
        setText();
    }
    ...
    private class ReadMoreClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            if (collapseListener != null) {
                collapseListener.onTextClick(readMore);
            }
            readMore = !readMore;
            setText();
        }
