...
public class DashboardSuperCPDetails extends AppCompatActivity {

    private static final String TAG = DashboardSuperCPDetails.class.getSimpleName();
    private Context context;
    private TextView textChName, textChLName, textMobile, textDOB, textLandline, textpersonalEmail, textOfficialEmail,
            textFirmName, textCommunicationAddress, textBusinessAddress, textHeader, firmType;
    ...
    private String sAddBusinessNature = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_super_cpdetails);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        initView();
        CallAppVersion callAppVersion = new CallAppVersion();
        callAppVersion.CallAppVersion(DashboardSuperCPDetails.this);
        viewListener();
        textWatch();
    ...
    private void initView() {
        ...
        context = DashboardSuperCPDetails.this;
    ...
    private void setHint() {
        ...
        textOfficialEmail.setText(ShowHintOrText.GetMandatory("Official Mail id"));
        ...
        textCommunicationAddress.setText(ShowHintOrText.GetMandatory("Communication Address"));
    ...
    private void setFontOnView() {
        ...
        actvBusinessNature.setTypeface(App.LATO_REGULAR);
    ...
    private void showDataOnView() {
        ...
        if (profileData.getNature_of_business() != null) {
            ...
            if (industryTypeData != null && industryTypeData.size() > 0)
                displayIndustryList();
        }
    }
    ...
    private void viewListener() {
        ...
        findBusinessPin.setOnClickListener(v -> {
            if (network.isNetworkConnected(context)) {
    ...
    private void callNextStep(EditProfileRequest editProfileReques1t) {
        if (!TextUtil.isStringNullOrBlank(callFrom)) {
            if (callFrom.equalsIgnoreCase("1")) {
            } else {
            ...
            public void onResponse(Call<ProfileResponce> call, Response<ProfileResponce> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Log.i("error4", errorBody.getMessage());
    ...
    public void getIndustryType() {
        ...
        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        final Call<IndustryTypeResponse> call = apiService.getIndustyType(mySingleton.getData(Constant.TOKEN_BASE_64), industryGroup_id);
                        ...
                        if (response.code() == 200) {
                            if (response.body().getStatus() == 1) {
                                if (response.body() != null) {
                                    ...
                                    Log.i(TAG, "json " + json); } else {
                                    displaySnackBar.DisplaySnackBar("Data not found", Constant.TYPE_ERROR);

                                }
                            } else if (response.body().getStatus() == 0) {
                                Log.e(TAG, "onResponse: status000" );                            }
                            callDisplayErrorCode(response.code(), "");
                        }
