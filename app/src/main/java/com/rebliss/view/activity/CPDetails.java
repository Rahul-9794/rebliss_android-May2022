...
public class CPDetails extends AppCompatActivity {
    ...
    RelativeLayout relAdhrLayout, relPanLayout,relBsnAddrLayout,relCheqlayout, relPassportLayout,
            relSignedLayout, relShopLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpdetails);
    ...
    private void initView() {
        ...
        relAdhrLayout = findViewById(R.id.relAdhrLayout);
        relPanLayout = findViewById(R.id.relPanLayout);
        relBsnAddrLayout = findViewById(R.id.relBsnAddrLayout);
        relCheqlayout = findViewById(R.id.relCheqlayout);
        relPassportLayout = findViewById(R.id.relPassportLayout);
        relSignedLayout = findViewById(R.id.relSignedLayout);
        relShopLayout = findViewById(R.id.relShopLayout);
                    ...
                    if (response.code() >= 200 && response.code() < 700) {
                        if (response.code() == 200) {
                            if (response.body().getStatus() == 1) {
                                ...
                                Log.e("TAG", "onResponse: status 0 for CPDetails" );                            }
    ...
    private void showDataOnView() {
        ...
        if(!TextUtil.isStringNullOrBlank(Adhar_Url)){
            ...
            relAdhrLayout.setVisibility(View.GONE);
        }
        ...
        if(!TextUtil.isStringNullOrBlank(Firm_Pan_Url)){
            ...
            Log.i("AAAAAAP", FirmPan_images[0]);
            ImageUploadAdapter panimageUploadAdapter;
        ...
        if(!TextUtil.isStringNullOrBlank(Passport_Url)){
            ...
            Log.i("AAAAAAP", Passport_images[0]);
            ImageUploadAdapter panimageUploadAdapter;
